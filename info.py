...
#main variables
API_ID = int(environ.get('API_ID', '12002491'))
API_HASH = environ.get('API_HASH', '51d83067b7a6d8d47d1241d93e6ff061')
BOT_TOKEN = environ.get('BOT_TOKEN', '7472865981:AAEbu7sMAdiJwu7NRK0h6KHLvVUEy8ZC7ho')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7396744912').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002278446572'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://itsdiverseop:itsdiverseop@cluster0.wg32h.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', ' -1002329278325'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002391097169'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002428370653'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', ' -1002253904605'))
